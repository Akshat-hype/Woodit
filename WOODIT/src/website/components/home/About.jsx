      ...
      <div className="mx-auto grid max-w-6xl items-center gap-20 md:grid-cols-2">
        ...
        <div className="max-w-xl">
          ...
          <p className="mt-8 text-[var(--wood-text)]/70 leading-relaxed">
            ...
            crafted using real wood, ensuring durability, strength, and a
            natural aesthetic that stands the test of time.
          </p>

          <p className="mt-5 text-[var(--wood-text)]/70 leading-relaxed">
            We primarily serve businesses in hospitality and interior design,
            while also offering select pieces for individual buyers. Our
            approach combines traditional craftsmanship with modern design to
            deliver furniture that feels both refined and functional.
          </p>
