...
const categoryImages = [
  theChairGallery,
  urbanMetalSeating,
  theHighSeatCollection,
  signatureSeating,
  diningAndLivingEnsembles,
  signatureBedroomSets,
  openAirCollection,
  cabinetsAndSideTables,
];
      ...
      <div className="page-shell">
        <div className="mb-10 grid gap-4 md:grid-cols-[1fr_360px] md:items-end">
          ...
          <p className="text-sm leading-6 text-[var(--color-text-muted)]">
            Furniture collections organized for hospitality buyers, interior
            projects, and custom residential spaces.
          </p>
        </div>
